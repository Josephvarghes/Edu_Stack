...
// const FREE_PLAN_VIDEO_LIMIT_MB = 100; // Cloudinary Free Tier limit

// /**
//  * Upload media (video or document) to Cloudinary with chunked support
//  */
...
//       throw new APIError('Unsupported video format. Use MP4, WebM, OGG, or MOV.', httpStatus.BAD_REQUEST);
//     }
//   }
...
//     throw new APIError(`Failed to upload media: ${error.message}`, httpStatus.INTERNAL_SERVER_ERROR);
//   }
// });
...
// /**
//  * Stream video from Cloudinary with Range support (for seeking)
//  */
// export const streamVideo = catchAsync(async (req, res) => {
//   const { mediaId } = req.params;
//   const media = await Media.findById(mediaId);
//   if (!media || media.type !== 'video') {
//     throw new APIError('Video not found', httpStatus.NOT_FOUND);
//   }

//   // Use stored publicId
//   const fullUrl = cloudinary.url(media.publicId, { 
//     resource_type: 'video', 
//     secure: true 
//   });
